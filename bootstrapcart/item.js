...
items[2] = new item(3, "Mandrake Root", 29.99);

items[3] = new item(4, "Tarot Cards", 9.99);
items[4] = new item(5, "Oujia Board", 19.99);
items[5] = new item(6, "Scrying Mirror", 59.99);
...
function displayCart()
{
    ...
    else
    {
        ...
        for( var x = 0; x < sessionStorage.length; x++)
        {
            ...
            output += "<td><input type='button' class='btn btn-primary' value='Delete' onclick='remove(\"" + key + "\")'></td></tr>"; //get the delete button and config arg for remove function
