function checkEmail()
{
    ...
    if(email == "") //conditional expression, when true, the code in the block will be executed
    {
    ...
    if(confirm == "") //conditional expression, when true, the code in the block will be executed
    {
